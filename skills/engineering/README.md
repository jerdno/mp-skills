...
- **[drawio-diagrams](./drawio-diagrams/SKILL.md)** — Lay out publication-ready draw.io diagrams on the first render: edge routing that keeps labels readable, multiple views as tabs in one file, a bundled geometric overlap checker for static exports, and C4 stencil templates when the view is a C4 one.
