...
- **[demonstrate](./demonstrate/SKILL.md)** — Prove a change does what was intended: a fresh subagent demonstrates the behaviour end-to-end and reports product-level evidence (screenshots, transcripts, findings), not green tests. Learns each project's manual-testing setup (tooling, auth) once, recording it in CLAUDE.md. User-invoked.
